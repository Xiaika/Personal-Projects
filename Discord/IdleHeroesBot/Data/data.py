...
with open('D:\PycharmProjects\BotTesting\Data\Corruption Data.csv') as file:
...
with open('D:\PycharmProjects\BotTesting\Data\Vortex Data.csv') as file:
    fields = file.readline()
    tiers = dict()
    for line in file.read().splitlines():
        line = line.split(',')
...
with open('D:\PycharmProjects\BotTesting\Data\Ark Data.csv') as file:
    fields = file.readline()
    sectors = dict()
    for line in file.read().splitlines():
        line = line.split(',')
